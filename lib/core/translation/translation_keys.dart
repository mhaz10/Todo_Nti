...
abstract class TranslationKeys
{
  ...
  static const thereAreNoTasksYet ="There are no tasks yet,\n Press the button \n To add New Task ";
  static const yourTodayIsTasksAlmostDone ="Your today’s tasks \n almost done! ";
  static const viewTasks ="View Tasks";
  static const inProgress ="In Progress";
  static const taskGroups ="Task Groups";
  static const workTask ="Work Task";
  static const personalTask ="Personal Task";
